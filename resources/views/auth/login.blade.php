...
<body class="font-sans antialiased text-gray-900">
    <section class="bg-gray-100 min-h-screen flex box-border justify-center items-center py-10">
        <div class="bg-white rounded-2xl flex max-w-4xl w-full p-5 items-center shadow-lg mx-4">
            <div class="md:w-1/2 px-8">
                <h2 class="font-bold text-3xl text-indigo-900">Login</h2>
                <p class="text-sm mt-4 text-indigo-900">Jika Anda sudah menjadi anggota, silakan login sekarang.</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4">
                    ...
                    <!-- Email -->
                    <div>
                        <input class="p-2 mt-8 rounded-xl border w-full {{ $errors->has('email') ? 'border-red-500' : '' }}" 
                    ...
                    <div class="relative">
                        <input class="p-2 rounded-xl border w-full {{ $errors->has('password') ? 'border-red-500' : '' }}" 
                               type="password" name="password" id="password" placeholder="Password" required autocomplete="current-password">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            id="hidePassword" viewBox="0 0 16 16">
                    ...
                    <button class="bg-indigo-600 text-white py-2 rounded-xl hover:scale-105 duration-300 hover:bg-indigo-700 font-medium" type="submit">Login</button>
                </form>
                ...
                <div class="mt-5 text-sm flex justify-between items-center text-indigo-900">
                    <a href="{{ route('password.request') }}" class="hover:underline opacity-80">Lupa password?</a>
                </div>

                <div class="mt-10 text-sm flex justify-between items-center text-indigo-900 border-t border-gray-200 pt-4">
                    <p>Belum punya akun?</p>
                    <a href="{{ route('register') }}" class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300 border-gray-400 text-indigo-900 font-semibold">Register</a>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if(togglePassword && hidePassword && password) {
                togglePassword.addEventListener('click', function (e) {
                    ...
                    hidePassword.classList.add('z-20');
                });
                ...
                hidePassword.addEventListener('click', function (e) {
                    ...
                    togglePassword.classList.add('z-20');
                });
            }
        });
    </script>
